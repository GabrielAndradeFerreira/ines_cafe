...
const courses = [
  {
    ...
    price: 249.90,
    category: "Barista",
    image: "./img/img1cursos.png",
  },
  {
    id: 2,
    title: "Curso de Cafés Especiais & Harmonização – INESCAFÉ '#5b3b2a'" ,
...
    inner.style.backgroundImage = `url('${c.image}')`; // LINHA CORRIGIDA
