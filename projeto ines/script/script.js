...
// BOTÃO MAIS DO MENU
// Seleciona o botão "Mais" e o dropdown
const maisBtn = document.getElementById("maisBtn");
const dropdown = maisBtn.nextElementSibling;

// Função para abrir/fechar ao clicar
maisBtn.addEventListener("click", function(e) {
  e.preventDefault(); // evita ir para "#"
  dropdown.classList.toggle("active");
});

// Fecha se clicar fora do dropdown
document.addEventListener("click", function(e) {
  if (!maisBtn.contains(e.target) && !dropdown.contains(e.target)) {
